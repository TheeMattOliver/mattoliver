...
// const serializers = {
//   types: {
//     block: (props) => PortableText.defaultSerializers.types.block(props),
//     mainImage: Figure,
//     image: Figure
//   },
// };
...
// const urlFor = source =>
//   urlBuilder({ projectId: "9ox83bxr", dataset: "production" }).image(source);
...
//           {_rawContent.slice(2).map(item => {
//             const imageData = getGatsbyImageData(item.image.assetId, { maxWidth: 1024 }, sanityConfig)
//             console.log({ item })
//             return (
//               <Section key={item._key}>
//                 <SectionHeaderWrapper >
//                   <SectionHeader id={item.anchor}>
//                     <PortableText blocks={item.heading} serializers={serializers} />
//                   </SectionHeader>
//                 </SectionHeaderWrapper>
...
//                   <SectionImageWrapper>
//                     <SectionMainImage
//                       image={getGatsbyImageData(item.image.asset.assetId, { maxWidth: 1024 }, sanityConfig)}
//                       alt={``}
//                     />
//                   </SectionImageWrapper>
//                 </SectionImageContainer>
...
//                       <>
//                         <SectionCopyGraf key={graf._key}>
//                           <PortableText blocks={graf} serializers={serializers} />
//                         </SectionCopyGraf>
//                         <br />
//                       </>
//                     )
