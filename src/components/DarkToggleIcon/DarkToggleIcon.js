      ...
      >
        {
          colorMode === 'light' && (
            <UnstyledButton aria-label="Activate dark mode" title="Activate dark mode">
              <MoonIcon
                className="h-10 w-10 pl-2 pr-2 -m-3 inline-block rounded-md hover:text-blue-500 transition ease-in-out duration-150"
        ...
        }
        {
          colorMode === 'dark' && (
            <UnstyledButton aria-label="Activate light mode" title="Activate light mode">
              <SunIcon
                className="h-10 w-10 pl-2 pr-2 -m-3 inline-block rounded-md hover:text-blue-300 transition ease-in-out duration-150"
